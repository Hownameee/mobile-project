...
import { recordIdSchema, recordSchema } from "../utils/schemas/record.schema.js";
...
recordRouter.get("/:recordId", validation(recordIdSchema, 'params'), recordController.getRecord);
